...
class _RoadsPersistence(Service, ServiceDB):
    ...
    def get_record_by_coordinates(self, coords: Coordinates) -> dict:
        ...
        point = Point(coords.get_coordinates()[::-1])
        ...
        road_record = record_list[0]
        self.__current_road = f"{road_record['tipo_via'].capitalize()} {road_record['nombre'].capitalize()}"
        return road_record
